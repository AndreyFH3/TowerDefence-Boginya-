...
public partial class @CameraControlScheme : IInputActionCollection2, IDisposable
{
    ...
    public struct MovementActions
    {
        ...
        public void SetCallbacks(IMovementActions instance)
        {
            ...
            {
                @DeltaMove.started -= m_Wrapper.m_MovementActionsCallbackInterface.OnDeltaMove;
                @DeltaMove.performed -= m_Wrapper.m_MovementActionsCallbackInterface.OnDeltaMove;
                @DeltaMove.canceled -= m_Wrapper.m_MovementActionsCallbackInterface.OnDeltaMove;
                @ZoomMouse.started -= m_Wrapper.m_MovementActionsCallbackInterface.OnZoomMouse;
                @ZoomMouse.performed -= m_Wrapper.m_MovementActionsCallbackInterface.OnZoomMouse;
                @ZoomMouse.canceled -= m_Wrapper.m_MovementActionsCallbackInterface.OnZoomMouse;
                @StartDeltaDrag.started -= m_Wrapper.m_MovementActionsCallbackInterface.OnStartDeltaDrag;
                @StartDeltaDrag.performed -= m_Wrapper.m_MovementActionsCallbackInterface.OnStartDeltaDrag;
                @StartDeltaDrag.canceled -= m_Wrapper.m_MovementActionsCallbackInterface.OnStartDeltaDrag;
            }
